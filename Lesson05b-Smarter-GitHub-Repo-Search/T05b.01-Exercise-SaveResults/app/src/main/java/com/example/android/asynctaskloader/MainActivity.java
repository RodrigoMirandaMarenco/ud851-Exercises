...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String urlDisplayContent = mUrlDisplayTextView.getText().toString();
        String searchResultsContent = mSearchResultsTextView.getText().toString();
        outState.putString(KEY_QUERY_URL, urlDisplayContent);
        outState.putString(KEY_RAW_JSON, searchResultsContent);
    }
